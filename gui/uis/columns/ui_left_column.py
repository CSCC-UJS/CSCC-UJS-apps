...
from gui.widgets.py_list_widget import PyListWidget

class Ui_LeftColumn(object):
    def setupUi(self, LeftColumn):
        if not LeftColumn.objectName():
            LeftColumn.setObjectName(u"LeftColumn")
        LeftColumn.resize(327, 600)
        ...
        self.videoItem_list = PyListWidget()
        self.videoItem_list.setObjectName(u"videoItem_list")
        self.videoItem_list.setEnabled(True)
        self.videoItem_list.setSpacing(10)

        self.verticalLayout.addWidget(self.videoItem_list)
